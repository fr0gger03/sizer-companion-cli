...
# ============================
    ...
    preparation_parser.add_argument('-vg', '--vcpu_grouping', type=int, choices=[2, 4], help='Show a summary table of mean resource values grouped by vCPU buckets of the specified size (2 or 4).')
